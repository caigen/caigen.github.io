...
The pthread.h file is a C/C++ header file under Linux/Unix. It is used for supporting multipule threads programming. The 'pthread.h' is short for 'POSIX thread header file'.
